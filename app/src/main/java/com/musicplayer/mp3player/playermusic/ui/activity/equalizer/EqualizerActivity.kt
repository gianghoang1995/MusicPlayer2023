package com.musicplayer.mp3player.playermusic.ui.activity.equalizer
...
import com.musicplayer.mp3player.playermusic.equalizer.databinding.ActivityEqualizerBinding
...
class EqualizerActivity : BaseActivity<ActivityEqualizerBinding>() {
    ...
    private fun showDialogPreset() {
        ...
        val equalizerAdapter = AdapterEqualizerRV(this, equalizerDelete = {
            position = -1
    ...
    private fun setDataSpinner() {
        ...
        binding.equalizer.spinner.adapter = spinnerAdapterRV
