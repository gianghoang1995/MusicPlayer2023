...
public class AdapterQueryFolderRV extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterQueryFolderRV(Context context, OnQueryFolderClickListener listener) {
