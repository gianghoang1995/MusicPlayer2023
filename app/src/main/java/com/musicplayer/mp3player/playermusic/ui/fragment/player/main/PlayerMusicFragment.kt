package com.musicplayer.mp3player.playermusic.ui.fragment.player.main
...
import com.musicplayer.mp3player.playermusic.equalizer.databinding.FragmentPlayerOnlineBinding
...
import com.musicplayer.mp3player.playermusic.ui.activity.playing.NowPlayingActivity
import com.musicplayer.mp3player.playermusic.ui.activity.playing.PlayerViewModel
import com.musicplayer.mp3player.playermusic.ui.dialog.DialogSelectSong
...
class PlayerMusicFragment : BaseFragment<FragmentPlayerOnlineBinding>(), OnBinderServiceConnection {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == AppCompatActivity.RESULT_OK) {
            ...
            if (resultCode == AppCompatActivity.RESULT_OK && requestCode == CROP_PIC) {
                ...
                EventBus.getDefault().post(BusRefreshData(true))
            }
        }
    }
    ...
    fun onLoveSong(item: BusPutLoveSong) {
        if (musicPlayerService != null) {
