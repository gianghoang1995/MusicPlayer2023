...
import com.musicplayer.mp3player.playermusic.adapter.viewholder.SongViewHolder
...
class SongAdapterRV(
    ...
    private val listener: SongListenerCallBack?,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return SongViewHolder(context, layoutInflater, parent)
    }
