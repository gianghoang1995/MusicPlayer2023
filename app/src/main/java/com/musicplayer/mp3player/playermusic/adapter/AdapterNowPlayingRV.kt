...
import com.musicplayer.mp3player.playermusic.adapter.viewholder.NowPlayingViewHolder
import com.musicplayer.mp3player.playermusic.adapter.viewholder.OnlineNowPlayingViewHolder
...
class AdapterNowPlayingRV(
    private val context: Context?, private val listener: SongListenerCallBack?,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return if (viewType == TYPE_OFFLINE) {
            ...
            NowPlayingViewHolder(context, layoutInflater, parent)
        } else {
            val layoutInflater = LayoutInflater.from(context)
            OnlineNowPlayingViewHolder(context, layoutInflater, parent)
        }
    }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        } else if (holder is OnlineNowPlayingViewHolder) {
            if (position == 0) {
