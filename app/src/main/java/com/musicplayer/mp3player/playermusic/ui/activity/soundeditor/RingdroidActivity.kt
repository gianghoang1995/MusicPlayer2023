package com.musicplayer.mp3player.playermusic.ui.activity.soundeditor
...
import com.musicplayer.mp3player.playermusic.equalizer.databinding.ActivityEditorBinding
import com.musicplayer.mp3player.playermusic.eventbus.BusRingtoneCreate
import com.musicplayer.mp3player.playermusic.ui.activity.soundeditor.utils.CheapSoundFile
import com.musicplayer.mp3player.playermusic.ui.activity.soundeditor.utils.MediaStoreHelper
import com.musicplayer.mp3player.playermusic.ui.activity.soundeditor.widget.MarkerView
import com.musicplayer.mp3player.playermusic.ui.activity.soundeditor.widget.WaveformView
import com.musicplayer.mp3player.playermusic.utils.AppUtils
import com.musicplayer.mp3player.playermusic.utils.Pixels
import com.musicplayer.mp3player.playermusic.utils.ViewUtil
...
class RingdroidActivity : BaseActivity<ActivityEditorBinding>(), MarkerView.MarkerListener,
    ...
    fun postFinishSetRingtone(uri: Uri?) {
        ...
        EventBus.getDefault().postSticky(BusRingtoneCreate(true))
        finish()
    }
