...
class FolderLoader(context: Context?, private val path: String?, listener: SongLoaderCallback) : BaseAsyncTaskLoader<List<MusicItem?>?>(context) {
    private val songListener: SongLoaderCallback = listener
