package com.musicplayer.mp3player.playermusic.ui.fragment.main.playlist
...
import com.musicplayer.mp3player.playermusic.adapter.PlaylistAdapterRV
...
import com.musicplayer.mp3player.playermusic.equalizer.databinding.FragmentPlaylistBinding
...
import com.musicplayer.mp3player.playermusic.ui.activity.sort_playlist.SortPlaylistActivity
...
class PlaylistFragment : BaseFragment<FragmentPlaylistBinding>() {
    ...
    lateinit var playlistAdapterRV: PlaylistAdapterRV
    ...
    fun init() {
        ...
        playlistAdapterRV =
            PlaylistAdapterRV(requireContext(), false, object : PlaylistCallBack {
        ...
        binding.rvFavorite.adapter = playlistAdapterRV
    ...
    private fun updateDataList() {
        ...
        playlistAdapterRV.setDataPlaylist(listPlaylist)
    ...
    private fun queryMusic(playlist: PlaylistITem, id: Int) {
        ...
        if (playlist.name.equals(FavoriteSqliteHelperDB.TABLE_RECENT_ADDED)) {
            val songLoader = SongLoaderAsync(requireContext(), object : SongLoaderCallback {
    ...
    fun onRefreshDataPlaylist(event: BusRefreshDataPlaylist) {
