package com.musicplayer.mp3player.playermusic.ui.activity.soundeditor.widget;
...
import com.musicplayer.mp3player.playermusic.ui.activity.soundeditor.utils.SelectionPoint;
...
//        mSelectedLinePaint.setColor(getResources().getColor(R.color.editor_selected_line_paint_color));
        mSelectedLinePaint.setShader(new LinearGradient(0, 0, 0, getHeight(),
                                                        Color.parseColor("#FFB300"),
                                                        Color.parseColor("#FFB300"), Shader.TileMode.MIRROR));
...
//                                                        Color.parseColor("#3676f7"),
//                                                        Color.parseColor("#d41fc1"), Shader.TileMode.MIRROR));
