package com.musicplayer.mp3player.playermusic.ui.fragment.main.album
...
import com.musicplayer.mp3player.playermusic.adapter.AdapterAlbumRV
...
import com.musicplayer.mp3player.playermusic.equalizer.databinding.FragmentAlbumsBinding
import com.musicplayer.mp3player.playermusic.callback.AlbumLoaderCallBack
...
class AlbumsFragment : BaseFragment<FragmentAlbumsBinding>(), AlbumLoaderCallBack,
    AlbumListenerCallback {
    var needLoaded = false
    private var popupSort: PopupMenu? = null
    private lateinit var songLoader: SongLoaderAsync
    var mLastClickTime: Long = 0
    lateinit var albumLoader: AlbumLoader
    lateinit var thread: Thread
    lateinit var albumAdapter: AdapterAlbumRV
    ...
    fun loader() {
        ...
        albumLoader = AlbumLoader(context, this)
    ...
    fun init() {
        ...
        albumAdapter = AdapterAlbumRV(context, this)
    ...
    private fun querySong(album: AlbumItem) {
        songLoader = SongLoaderAsync(context, object : SongLoaderCallback {
