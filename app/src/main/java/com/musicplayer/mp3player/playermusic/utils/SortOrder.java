...
public final class SortOrder {
    ...
    public interface SongSortOrder {
        ...
        String SONG_ARTIST_A_Z = MediaStore.Audio.Media.ARTIST + " ASC";

        String SONG_ARTIST_Z_A = MediaStore.Audio.Media.ARTIST + " DESC";

        /* Song sort order album */
        String SONG_ALBUM_A_Z = MediaStore.Audio.Media.ALBUM + " ASC";

        String SONG_ALBUM_Z_A = MediaStore.Audio.Media.ALBUM + " DESC";

        /* Song sort order year */
        String SONG_YEAR_A_Z = MediaStore.Audio.Media.YEAR + " ASC";

        String SONG_YEAR_Z_A = MediaStore.Audio.Media.YEAR + " DESC";

        /* Song sort order duration */
        String SONG_DURATION = MediaStore.Audio.Media.DURATION + " DESC";

        /* Song sort order date */
        String SONG_DATE_ADDED_A_Z = MediaStore.Audio.Media.DATE_ADDED + " ASC";

        String SONG_DATE_ADDED_Z_A = MediaStore.Audio.Media.DATE_ADDED + " DESC";
    }
