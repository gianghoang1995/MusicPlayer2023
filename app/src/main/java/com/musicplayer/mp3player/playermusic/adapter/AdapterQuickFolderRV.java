...
public class AdapterQuickFolderRV extends RecyclerView.Adapter<AdapterQuickFolderRV.QuickFolderViewHolder> {
    private Context mContext;
    private OnQuickFolderClick listener;
    private ArrayList<FolderItem> lstQuickFolder = new ArrayList<>();


    public AdapterQuickFolderRV(Context context, OnQuickFolderClick listener) {
        mContext = context;
