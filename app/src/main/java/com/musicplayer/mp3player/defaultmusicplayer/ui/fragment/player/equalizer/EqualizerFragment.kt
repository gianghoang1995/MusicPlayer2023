package com.musicplayer.mp3player.defaultmusicplayer.ui.fragment.player.equalizer
...
import com.musicplayer.mp3player.defaultmusicplayer.adapter.AdapterEqualizer
import com.musicplayer.mp3player.defaultmusicplayer.adapter.SpinnerAdapter
...
import com.musicplayer.mp3player.defaultmusicplayer.equalizer.databinding.FragmentEqualizerBinding
...
import com.musicplayer.mp3player.defaultmusicplayer.widget.SeekBarEqualizer
...
class EqualizerFragment : BaseFragment<FragmentEqualizerBinding>() {
    ...
    fun showDialogPreset() {
        ...
        val equalizerAdapter = AdapterEqualizer(context,
            equalizerDelete = {
    ...
    fun setDataSpinner() {
        ...
        spinnerAdapter = context?.let { SpinnerAdapter(it, listEqualizer) }!!
