...
public class AdapterSelectSong extends RecyclerView.Adapter<AdapterSelectSong.SelectSongViewHolder> {
    ...
    public AdapterSelectSong(Context context, OnClickSelectSongListener listener) {
