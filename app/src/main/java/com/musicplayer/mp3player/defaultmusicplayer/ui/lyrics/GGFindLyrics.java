...
public class GGFindLyrics {
    ...
    public void findLyrics(final String query, final OnFindLyricCallback listener) {
    ...
    public class AsyncLoadLyric extends AsyncTask<Void, Void, Void> {
        String urlRequest = "";
        OnFindLyricCallback onFindLyricListener;
        String lyricContent = "";
        ...
        public void setCallback(OnFindLyricCallback findLyricListener) {
