...
public class AdsPlashUtils {
    ...
    public void loadAd(Context context, OnLoadAdsPlashListener adsPlashListener) {
        loadPrepareAds(context, context.getString(R.string.full_plash_01), adsPlashListener, () -> {
            loadPrepareAds(context, context.getString(R.string.full_plash_02), adsPlashListener,adsPlashListener::onFinishLoad);
        });
    }
