...
object AppConstants {
    ...
    const val DEFAULT_FOLDER_NAME = "MusicDownloader"
    ...
    fun testDevices(): List<String> {
        return listOf(
            ...
            "38EA7C1B9CEFEBC7CB492AE3A3369DDB"
        )
    }
    ...
    fun getListCategory(context: Context): ArrayList<CategoryItem> {
        var listCategory = ArrayList<CategoryItem>()
        listCategory.add(
            CategoryItem(
                context.getString(R.string.category_carmusic),
                R.drawable.cate_carmusic,
                "#e53063",
                "Car Edm"
            )
        )
        listCategory.add(
            CategoryItem(
                context.getString(R.string.category_edm),
                R.drawable.cate_edm,
                "#a2ddeb",
                "EDM"
            )
        ...
        listCategory.add(
            CategoryItem(
                context.getString(R.string.category_tiktok_remix),
                R.drawable.cate_tiktok_remix,
                "#993d88",
                "Tiktok Remix Music"
            )
        )
        listCategory.add(
            CategoryItem(
                context.getString(R.string.category_acoustic),
                R.drawable.cate_acoustic,
                "#ffcac6",
                "Acoustic"
            )
        )
        listCategory.add(
            CategoryItem(
                context.getString(R.string.category_chill),
                R.drawable.cate_chill,
                "#00569f",
                "Chill Music"
            )
        )
        ...
        listCategory.add(
            CategoryItem(
                context.getString(R.string.category_indie),
                R.drawable.cate_indie,
                "#fec142",
                "Indie Music"
            )
        )
        listCategory.add(
            CategoryItem(
                context.getString(R.string.category_piano),
                R.drawable.cate_piano,
                "#72a1bd",
                "Piano Music"
            )
        )
        listCategory.add(
            CategoryItem(
                context.getString(R.string.category_rock),
                R.drawable.cate_rock,
                "#8f6b55",
                "Rock Music"
            )
        )
        listCategory.add(
            CategoryItem(
                context.getString(R.string.category_rain),
                R.drawable.cate_rain,
                "#00656f",
                "Rain Music"
            )
        )
        listCategory.add(
            CategoryItem(
                context.getString(R.string.category_toursim),
                R.drawable.cate_toursim,
                "#ea311c",
                "Toursim Music"
            )
        )
        listCategory.add(
            CategoryItem(
                context.getString(R.string.category_workout),
                R.drawable.cate_workout,
                "#7d9f84",
                "Workout Music"
            )
        )
        listCategory.add(
            CategoryItem(
                context.getString(R.string.category_hiphop),
                R.drawable.cate_hiphop,
                "#43A047",
                "Hiphop Music"
