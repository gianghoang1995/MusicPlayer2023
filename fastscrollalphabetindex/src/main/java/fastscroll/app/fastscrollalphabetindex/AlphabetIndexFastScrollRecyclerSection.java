...
public class AlphabetIndexFastScrollRecyclerSection extends RecyclerView.AdapterDataObserver {
    ...
    private static final long DURATION_FADED_INVISIBLE_INDEX = 3000;
    ...
    public void animateVisibility(final boolean visible) {
        if (mAlphaAnimator != null) {
            mAlphaAnimator.cancel();
        }
        mAlphaAnimator = ObjectAnimator.ofFloat(indexbarPaint, "alpha", visible ? 1f : 0f);
        ...
        mAlphaAnimator.setDuration(visible ? 200 : DURATION_FADED_INVISIBLE_INDEX);
    ...
    public void onSizeChanged(int w, int h, int oldw, int oldh) {
        float heightSection = (h / 4) * 3;
        mListViewWidth = w;
        mListViewHeight = h;
        mIndexbarRect = new RectF(w - mIndexbarMargin - mIndexbarWidth
                , (h - mIndexbarMargin - heightSection) / 2
                , w - mIndexbarMargin
                , (h - mIndexbarMargin - heightSection) / 2 + heightSection - mIndexbarMargin);
    }
